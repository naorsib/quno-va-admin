  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        'circular-motion-fastest': 'circular-motion 12s linear infinite',
        'circular-motion-faster': 'circular-motion 12.2s linear infinite',
        'circular-motion-fast': 'circular-motion 12.5s linear infinite reverse',
        'circular-motion-normal':
          'circular-motion 12.8s linear infinite reverse',
        'circular-motion-slow': 'circular-motion 13s linear infinite',
      },
    },
  },
